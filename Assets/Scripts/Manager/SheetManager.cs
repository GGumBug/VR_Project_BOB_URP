...
public class SheetManager : MonoBehaviour
{
    ...
    public string[] title = { "Bang", "Bones", "Welcome To Hell", "Lalalalalalalalalala", "Lucky Strike", "Underground Sound", "No War", "As The World Caves In", "Ditto", "A Thousand Miles" };
